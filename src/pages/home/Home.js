              ...
              <Col xs={12} className={` text-center ${styles.Header}`}>
                ...
                <Row className="mt-3">
                  <Col className={`text-center  ${styles.Creative} `} md={6}>
                    {/* The Creative links */}
                    <h4 className={`mb-2 ${styles.Creative}`}>The Creative</h4>
                    <p
                  ...
                  <Col md={6} className={` ${styles.Creative} `}>
                    <h4 className={`mb-2 ${styles.Creative}`}>Production</h4>
                    <p
                      className={`${styles.Header}`}
                      style={{ fontStyle: "italic" }}
                    >
          ...
          justify-content-center`}
              >
                ...
                <Col xs={9} className="text-center">
                  ...
                  <p>
                    Create a Scene Page for each Scene that contains the all the
                    work features including Breakdowns and Department
                    Workspaces.
                  </p>
                </Col>
              </div>
           ...
           justify-content-center`}
              >
                <Col xs={9} className="text-center">
                  ...
                  <p>
                    Use Moodboards to guide and design Scenes, Characters and
                    Locations. Use Indexshots to design sequences and previs
                    visual style flow.
                  </p>
                </Col>
                <Col xs={3}>
          ...
          justify-content-center`}
              >
                ...
                <Col xs={9} className="text-center">
                  ...
                  <p>
                    Create the Shotlist in the Scene Page and add the Storyboard
          ...
          justify-content-center`}
              >
                <Col xs={9} className="text-center">
                  ...
                  <p>
                    Create Characters and Locations Pages with Images and all
                    relevant Info.
                  </p>
                </Col>
                <Col xs={3}>
          ...
          justify-content-center`}
              >
                ...
                <Col xs={9} className="text-center">
                  <h4>Cast and Crew</h4>
                  <p>
                    Manage the Cast and Crew with all the necessary Info
                    Requirements
                  </p>
                </Col>
              </div>
          ...
          justify-content-center`}
              >
                ...
                <Col xs={9} className="text-center">
                  <h4>Callsheets</h4>
                  <p>
                    Create stylish Callsheets with personalized Call Times and
          ...
          justify-content-center`}
              >
                <Col xs={9} className="text-center">
                  <h4>Mobile View</h4>
                  <p>
                    Use all Features in Mobile View and find all Info fast using
