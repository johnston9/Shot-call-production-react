  ...
  return (
    <div>
      <div className={`${styles.Overview}`}>
        <h2
          className={`py-2 ${styles.OverviewText} ${appStyles.playfair}
     text-center`}
        >
          {title} Budget{" "}
        </h2>
        ...
        <Row className="mt-0 mb-4">
          <Col className="text-center">
            <Link to={`/${projectId}/budgets/edit`}>
              <div className={`px-1`}>
                <span className={`${styles.BudgetLink} py-1 px-3`}>
                  Edit Budget
                </span>
              </div>
            </Link>
        ...
        <Row className="mt-0 mb-5">
          ...
          >
            <Link to={`/budgets/create/${projectId}`}>
              <div className={`px-1`}>
                <spam className={`${styles.BudgetLink} py-1 px-3`}>
                  Create Budget
                </spam>
              </div>
            </Link>
      ...
      <div className="px-3">
        ...
        <div>
          ...
          <Row>
            ...
            <Col xs={12} md={6}>
              <h5
                className={`${styles.Bold} d-none d-md-block mb-2 text-center`}
              >
                Length
              </h5>
            </Col>
          ...
          <Row className="px-3">
            ...
            <Col xs={12} md={6}>
              ...
              <Row>
                <Col xs={12} md={6}>
                  <h5
                    className={`${styles.Bold} d-block d-md-none mb-2 text-center`}
                  >
                    Length
                  </h5>
                </Col>
